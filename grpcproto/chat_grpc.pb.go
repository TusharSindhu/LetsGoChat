...
type ChatServiceClient interface {
	...
	ReceiveMessages(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChatMessage], error)
}
...
func (c *chatServiceClient) ReceiveMessages(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChatMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ChatServiceServer interface {
	...
	ReceiveMessages(*Empty, grpc.ServerStreamingServer[ChatMessage]) error
...
func (UnimplementedChatServiceServer) ReceiveMessages(*Empty, grpc.ServerStreamingServer[ChatMessage]) error {
...
func _ChatService_ReceiveMessages_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ChatServiceServer).ReceiveMessages(m, &grpc.GenericServerStream[Empty, ChatMessage]{ServerStream: stream})
}
